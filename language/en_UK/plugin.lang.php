...
$lang = array(												 
    ...
    'log_thumb_progress_line'           => 'Thumbnail %d of %d (%d%%) – Image ID %d%s – Type: %s | Path: %s',
    ...
    'log_sync_step1_summary'            => 'Synchronisation completed. Added: %d, Deleted: %d, Delta: %d (before: %d, after: %d)',
